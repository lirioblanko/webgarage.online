...
if (stageEl) {
  (function () {
    ...
    //************
    function init() {
      _Canvas = new Canvas({stage: stageEl});
    ...
    class MaskedImage {
      ...
      draw(x = 0, y = 0) {
        if (this.hasImg) {
          _Canvas.context.drawImage(this.img, 0, 0, _Canvas._stageWidth, _Canvas._stageHeight);
        }
      }
      ...
      scale() {
        ...
        TweenMax.fromTo(this.empty, _tweenTime, {alpha: 1, scale: 0}, {
          alpha: 1, scale: 1, onComplete: function () {
